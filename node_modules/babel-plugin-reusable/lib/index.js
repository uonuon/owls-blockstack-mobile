...
const validImportNames = ['reusable', 'reusable/macro'];
                      ...
                      ImportSpecifier(importSpecifierPath) {
                        ...
                        if (methodName === 'createStore' || methodName === localName) {
                          if (t.isArrowFunctionExpression(path.node.arguments[0])) {
                            const functionDeclaration = t.functionDeclaration(path.parent.id, path.node.arguments[0].params, path.node.arguments[0].body);
